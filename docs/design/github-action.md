...
prepends. The projection meets that least important first, cutting a section of whole symbols to a
name-and-location list before it drops any, and says at the top of the report which sections it
shortened and which it dropped ([`markdown-projection.md`](./markdown-projection.md)
