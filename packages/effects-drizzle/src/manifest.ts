 ...
 * raw SQL disambiguation) would sit there once introduced. `derivedByPrefixes` shares
 * its literal with the classifier's tag builder so both stay in lockstep across edits.
 */
