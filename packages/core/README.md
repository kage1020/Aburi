...
- **IR invariants** (`assertIRIntegrity`) — the ir-schema.md contract every scan / diff
...
- [`docs/design/ir-schema.md`](../../docs/design/ir-schema.md) — IR contract + the integrity invariants.
